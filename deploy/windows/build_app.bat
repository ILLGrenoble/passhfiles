...
rem the path to the git directory for passhfiles
set git_dir=%2
...
for /f %%i in ('dir /a:d /S /B passhfiles*') do rmdir /S /Q %%i
del /Q %target_dir%\Scripts\passhfiles

rem checkout selected version of the passhfiles project
